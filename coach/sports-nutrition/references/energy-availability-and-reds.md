# Energy Availability & RED-S Prevention

Low Energy Availability (LEA) occurs when an athlete's dietary energy intake is insufficient to support the physiological background body functions after accounting for the energy expended during exercise.

> [!WARNING]
> **Medical Disclaimer**: Relative Energy Deficiency in Sport (RED-S) is a complex clinical condition affecting endocrinology, bone health, and mental health. This guide is for educational screening purposes. Athletes presenting with symptoms must be referred to a physician and sports dietitian.
...
| Energy Availability Zone | EA Range (kcal/kg FFM/day) | Physiological Impact |
| ------------------------ | --------------------------- | -------------------- |
| **Optimal EA** | **$\ge 45\text{ kcal/kg FFM/day}$** | Supports endocrine function, bone remodeling, immune response, and adaptation |
| **Sub-optimal EA** | **$30\text{--}44\text{ kcal/kg FFM/day}$** | Marginal state; tolerable for short body composition phases under supervision |
| **Low Energy Availability (LEA)** | **$< 30\text{ kcal/kg FFM/day}$** | **Clinical Danger Zone**: Down-regulates thyroid, sex hormones, bone turnover, and metabolic rate |
...
## 3. Nutritional Recovery Protocol for RED-S

1. **Immediate Energy Surplus**: Increase daily caloric intake by 300–600 kcal/day, prioritizing carbohydrate availability to restore thyroid ($T_3$) and gonadotropin-releasing hormone (GnRH) pulsatility.
