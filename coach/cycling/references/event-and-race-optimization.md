# Event & Race Optimization Strategy

Comprehensive guide for event prioritization, course profile diagnostics, peak/taper periodization, and race-day tactical execution for competitive cycling.

---

## 1. A / B / C Race Prioritization Framework

Not all races require maximum physical preparation. Structuring events into priority tiers preserves mental drive and prevents physiological burnout.

| Tier | Goal / Purpose | Preparation Strategy | Taper Schedule | Post-Race Action |
|------|────────────────|──────────────────────|----------------|------------------|
| **A-Race** | Peak Performance (1–3 events/year) | Full peak/taper cycle, macrocycle target | 10–14 days exponential taper | 5–7 days recovery / active spin |
| **B-Race** | Benchmark & Race Sharpness (3–6/year) | Train-through; minor fatigue reduction | 3–4 days volume reduction | 2–3 days active recovery |
| **C-Race** | High-Intensity Training / Fun | Treat as a hard structured workout | 0–1 day (normal rest day prior) | Resume normal weekly plan |

---

## 2. Target Event Profiling & Route Diagnostics
...
## 3. The 14-Day Peak & Taper Protocol (A-Race)

The objective of a taper is to reduce physiological fatigue (ATL) while maintaining chronic fitness (CTL) and neuromuscular priming.

```
Macrocycle Fitness Peak (CTL ~ 90)
 ├── Day -14 to -8: Taper Phase 1 (Volume -30%, Intensity Maintained)
 ├── Day -7 to -3:  Taper Phase 2 (Volume -50%, Short Openers)
 ├── Day -2:        PASSIVE REST DAY
 └── Day -1:        25-Minute Openers (2x1m @ Race Pace)
 └── Day 0:         A-RACE DAY (TSB +15 to +25)
```
